...
(function($, window, document, undefined) {
    "use strict";
    var pluginName = "BalancedGallery", balancedGallery, defaults = {
        autoResize: true,
        background: null,
        idealHeight: null,
        idealWidth: null,
        ...
        viewportHeight: null,
        viewportWidth: null
    }, ALL_CHILDREN_LOADED = "ALL_CHILDREN_LOADED", resizeTimeout = null, RADIX = 10;
    ...
    function BalancedGallery(element, options) {
        balancedGallery = this;
        // for contexts when 'this' doesn't refer to the BalancedGallery class.
        this.element = element;
        this.elementChildren = $(element).children("*");
        this.options = $.extend({}, defaults, options);
        // merge arg options and defaults
    ...
    function getOrderedPartition(weights, sections) {
        ...
        if (sections >= elementCount) {
            return weights.map(function(key, value) {
                return [ [ value ] ];
            });
        }
    ...
    function getUnorderedPartition(weights, sections) {
        var sortedWeights = weights.sort(function(a, b) {
    ...
    function resizeVerticalElements(partitions) {
        ...
        $(balancedGallery.container).width(function() {
            var sum = 0;
            $(".balanced-gallery-column").each(function() {
                sum += $(this).width();
            });
            return sum;
        }());
    ...
    function orientElementsVertically(partitions) {
        var $element = $(balancedGallery.element), $container;
        $element.html("");
        //clear the images
        $element.css({
            overflow: "scroll"
...
$(document).ready(function() {
    var window_height = $(window).height(), window_width = $(window).width(), navigation_height;
    /* ============== SLIDERS ============== */
    $("#header-slide").slick({
        dots: true,
        autoplay: true,
